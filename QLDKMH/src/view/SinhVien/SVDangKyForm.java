...
public class SVDangKyForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tblDKTinChi.setModel(new DefaultTableModel(
            new Object [][] {
    ...
    private void btnTimKiemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTimKiemActionPerformed
        ...
        List<LopHoc> listLHSub = qllhc.timKiemByMaMH(maMH);
        List<GVDangKy> listGVDK = new ArrayList<>();

        for (LopHoc lh : listLHSub) {
            GVDangKy gvdk = qlgvdkc.timKiemLopHocGVDaDangKy(lh.getMaLH());
            listGVDK.add(gvdk);
        }
