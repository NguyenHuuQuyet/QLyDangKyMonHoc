...
public class QLSinhVienForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tblQLSinhVien = new javax.swing.JTable();
        ...
        tblQLSinhVien.setModel(new DefaultTableModel(
            new Object [][] {
        ...
        tblQLSinhVien.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tblQLSinhVienMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(tblQLSinhVien);
    ...
    private void initTable() {
        String[] columns = new String[]{"STT", "Mã Sinh Viên", "Tên Sinh Viên", "Lớp", "Số ĐT", "Địa chỉ", "Email"};
        tblModel.setColumnIdentifiers(columns);
        tblQLSinhVien.setModel(tblModel);
    }

    private void fillTable() {
        tblModel.setRowCount(0);
        listSV = qlsvc.getListSV();
        int index = 1;
        for (SinhVien sinhVien : listSV) {
            tblModel.addRow(new Object[]{index++, sinhVien.getMaSV(), sinhVien.getTenSV(), sinhVien.getLop(),
                sinhVien.getSoDT(), sinhVien.getDiaChi(), sinhVien.getEmail()});
        }
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        ...
        if (!isHadEmptyField()) {
            ...
            SinhVien sv = null;
            sv = qlsvc.timKiemByMaSV(maSV);
            if (sv == null) {
                TaoTKSVDialog tkDialog = new TaoTKSVDialog(this, true);
                tk.setId(tkDialog.getTK().getId());
                sv = new SinhVien(maSV, tenSV, lop, soDT, diaChi, email, tk.getId());
                qlsvc.themSV(sv);
            } else {
    ...
    private void btnSuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSuaActionPerformed
        if (!isHadEmptyField()) {
            ...
            String diaChi = txtDiaChi.getText().trim();
            String email = txtEmail.getText().trim();
            String id = qlsvc.getSVByMaSV(maSV).getId();
    ...
    private void btnXoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXoaActionPerformed
        ...
        selectedRow = tblQLSinhVien.getSelectedRow();
        if (selectedRow >= 0) {
            SinhVien sv = listSV.get(selectedRow);
            qlsvc.xoaSV(sv.getId());
        }
        resetData();
        fillTable();
    ...
    private void btnTimKiemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTimKiemActionPerformed
        if (!(txtMaSV.getText().isBlank())) {
            ...
            SinhVien sv = qlsvc.timKiemByMaSV(maSV);
            ...
            txtMaSV.setBackground(Color.CYAN);
            JOptionPane.showMessageDialog(rootPane, "Hãy nhập Mã sinh viên cần tìm");
        }

    }//GEN-LAST:event_btnTimKiemActionPerformed

    private void tblQLSinhVienMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblQLSinhVienMouseClicked
        selectedRow = tblQLSinhVien.getSelectedRow();
        if (selectedRow >= 0) {
            SinhVien sv = listSV.get(selectedRow);
            txtMaSV.setText(sv.getMaSV());
    ...
    }//GEN-LAST:event_tblQLSinhVienMouseClicked
    ...
    private javax.swing.JTable tblQLSinhVien;
